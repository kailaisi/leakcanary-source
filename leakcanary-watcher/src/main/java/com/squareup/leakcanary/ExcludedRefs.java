...
public final class ExcludedRefs implements Serializable {
    ...
    //这里设置的排除监控的类和属性信息，直接使用的是unmodifiableMap，启用以后就不再进行修改了
    ...
    public static final class BuilderWithParams implements Builder {
        //排除的类中的属性字段。以类为key，以属性字段组合为map来进行记录
        ...
        //设置排除引用监控的原因。这里每次设置都将其对应的参数设置给lastParams,然后再设置reason，
        // 为什么不直接将其作为参数设置到ParamsBuilder中呢？
